            ...
            <div>
                <p class="text-sm text-gray-200 leading-5 dark:text-gray-400">
                    ...
                    @if ($paginator->firstItem())
                        <span class="font-bold text-black px-1 border rounded text-center py1 items-center">{{ $paginator->firstItem() }}</span>
                        {!! __('to') !!}
                        <span class="font-bold text-black px-1 border rounded text-center py1 items-center">{{ $paginator->lastItem() }}</span>
                    @else
                        {{ $paginator->count() }}
                    @endif
                    {!! __('of') !!}
                    <span class="font-bold text-black px-1 border rounded text-center py1 items-center">{{ $paginator->total() }}</span>
                    {!! __('results') !!}
                </p>
            </div>
